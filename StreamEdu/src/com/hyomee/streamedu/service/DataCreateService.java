...
public class DataCreateService {
  ...
  public static List<SubjectDTO> createSubjectList() {
    ...
    subjectlDTOList.add(new SubjectDTO("USER_01", "SUBJECT_01", "국어", 80));
    subjectlDTOList.add(new SubjectDTO("USER_01", "SUBJECT_02", "영어", 90));
    subjectlDTOList.add(new SubjectDTO("USER_01", "SUBJECT_02", "수학", 85));
    subjectlDTOList.add(new SubjectDTO("USER_02", "SUBJECT_02", "국어", 70));
    subjectlDTOList.add(new SubjectDTO("USER_02", "SUBJECT_02", "영어", 80));
    subjectlDTOList.add(new SubjectDTO("USER_02", "SUBJECT_02", "수학", 75));
    subjectlDTOList.add(new SubjectDTO("USER_03", "SUBJECT_02", "국어", 95));
    subjectlDTOList.add(new SubjectDTO("USER_03", "SUBJECT_02", "영어", 65));
    subjectlDTOList.add(new SubjectDTO("USER_03", "SUBJECT_02", "수학", 75));
    subjectlDTOList.add(new SubjectDTO("USER_04", "SUBJECT_02", "국어", 95));
    subjectlDTOList.add(new SubjectDTO("USER_04", "SUBJECT_02", "영어", 85));
    subjectlDTOList.add(new SubjectDTO("USER_05", "SUBJECT_02", "수학", 75));
